        ...
        def f(method, _id=None, payload=None, unset_payload=None, recursive=False, r_payload=None, replace_metadata=False):
            ...
            if method == 'GET' and container.get('public', False):
                ...
                if target_parent_container.get('roles'):
                    ...
                    required_perm = 'admin'
                has_access = _get_access(handler.uid, target_parent_container) >= INTEGER_ROLES[required_perm]
            elif method == 'DELETE':
                required_perm = 'rw'
                ...
                if target_parent_container:
                    ...
                    has_access = _get_access(handler.uid, container) >= INTEGER_ROLES[required_perm]
