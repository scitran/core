...
routes = [
    ...
    webapp2_extras.routes.PathPrefixRoute(r'/api/projects', [
        ...
        webapp2.Route(r'/<:[0-9a-f]{24}>/files',                     projects.Project, handler_method='file', methods=['POST']),
        webapp2.Route(r'/<:[0-9a-f]{24}>/files/<:[^/]+>',            projects.Project, handler_method='file'),
        ...
        webapp2.Route(r'/<cid:[^/]+>/file',                        listhandler.FileListHandler, name='pj_files_post', methods=['POST'],
            defaults={'permchecker': permchecker.default_sublist, 'storage': storage.ListStorage('projects', 'files', True)}),
    ...
    webapp2_extras.routes.PathPrefixRoute(r'/api/acquisitions', [
        ...
        webapp2.Route(r'/<:[0-9a-f]{24}>/files',                     acquisitions.Acquisition, handler_method='file', methods=['POST']),
        webapp2.Route(r'/<:[0-9a-f]{24}>/files/<:[^/]+>',            acquisitions.Acquisition, handler_method='file'),
        ...
        webapp2.Route(r'/<cid:[^/]+>/file',                        listhandler.FileListHandler, name='aq_files_post', methods=['POST'],
            defaults={'permchecker': permchecker.default_sublist, 'storage': storage.ListStorage('acquisitions', 'files', True)}),
