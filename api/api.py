...
routes = [
    ...
    webapp2_extras.routes.PathPrefixRoute(r'/api/groups', [
        ...
        webapp2.Route(r'/<cid:[^/]+>/roles',                        listhandler.ListHandler, methods=['POST'], defaults={'cont_name': 'groups', 'list_name': 'roles'}),
    ...
    webapp2.Route(r'/api/<cont_name:[^/]+>/<cid:[^/]+>/tags',                       listhandler.ListHandler, methods=['POST'], name='tags_post', defaults={'list_name': 'tags'}),
    webapp2.Route(r'/api/<cont_name:[^/]+>/<cid:[^/]+>/tags/<value:[^/]+>',         listhandler.ListHandler, name='tags', defaults={'list_name': 'tags'}),
    ...
    webapp2.Route(r'/api/<cont_name:[^/]+>/api/collections/curators',               collectionshandler.CollectionsHandler, handler_method='curators', methods=['GET']),
    ...
    webapp2.Route(r'/api/<cont_name:collections>/<cid:[^/]+>/sessions',             collectionshandler.CollectionsHandler, name='coll_ses', handler_method='get_sessions', methods=['GET']),
    webapp2.Route(r'/api/<cont_name:collections>/<cid:[^/]+>/acquisitions',         collectionshandler.CollectionsHandler, name='coll_acq',handler_method='get_acquisitions', methods=['GET']),

    webapp2.Route(r'/api/users/<uid:[^/]+>/<cont_name:[^/]+>',                      containerhandler.ContainerHandler, name='user_conts', handler_method='get_all_for_user', methods=['GET']),
    webapp2.Route(r'/api/projects/groups',                                          containerhandler.ContainerHandler, handler_method='get_groups_with_project', methods=['GET']),
    webapp2.Route(r'/api/<par_cont_name:[^/]+>/<par_id:[^/]+>/<cont_name:[^/]+>',   containerhandler.ContainerHandler, name='cont_sublist', handler_method='get_all', methods=['GET']),
    webapp2.Route(r'/api/<cont_name:[^/]+>',                                        containerhandler.ContainerHandler, name='cont_list', handler_method='get_all', methods=['GET']),
    webapp2.Route(r'/api/<cont_name:[^/]+>',                                        containerhandler.ContainerHandler, methods=['POST']),
    webapp2.Route(r'/api/<cont_name:[^/]+>/<cid:[^/]+>',                            containerhandler.ContainerHandler, name='cont_details', methods=['GET','PUT','DELETE']),
]
