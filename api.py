...
routes = [
    ...
    webapp2_extras.routes.PathPrefixRoute(r'/nimsapi/users', [
        ...
        webapp2.Route(r'/<uid>',                                        users.User, name='user'),
        webapp2.Route(r'/<uid>/groups',                                 users.Groups, name='groups'),
    ]),
    ...
    webapp2_extras.routes.PathPrefixRoute(r'/nimsapi/groups', [
        ...
        webapp2.Route(r'/<gid>',                                        users.Group, name='group'),
    ]),
    ...
    webapp2_extras.routes.PathPrefixRoute(r'/nimsapi/experiments', [
        ...
        webapp2.Route(r'/<_id:[0-9a-f]{24}>',                           experiments.Experiment, name='experiment'),
        webapp2.Route(r'/<_id:[0-9a-f]{24}>/sessions',                  experiments.Sessions, name='sessions'),
    ]),
    ...
    webapp2_extras.routes.PathPrefixRoute(r'/nimsapi/collections', [
        ...
        webapp2.Route(r'/<_id:[0-9a-f]{24}>',                           collections_.Collection, name='collection'),
        webapp2.Route(r'/<_id:[0-9a-f]{24}>/sessions',                  collections_.Sessions, name='vp_sessions'),
        webapp2.Route(r'/<_id:[0-9a-f]{24}>/epochs',                    collections_.Epochs, name='vp_epochs'),
    ]),
    webapp2_extras.routes.PathPrefixRoute(r'/nimsapi/sessions', [
        ...
        webapp2.Route(r'/<_id:[0-9a-f]{24}>',                           experiments.Session, name='session'),
        webapp2.Route(r'/<_id:[0-9a-f]{24}>/epochs',                    experiments.Epochs, name='epochs'),
    ]),
    webapp2_extras.routes.PathPrefixRoute(r'/nimsapi/epochs', [
        ...
        webapp2.Route(r'/<_id:[0-9a-f]{24}>',                           experiments.Epoch, name='epoch'),
    ]),
]
